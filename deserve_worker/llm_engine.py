...
from deserve_worker.execution.response import BatchUpdate, LLMResponse, TraceResult
...
from .execution.exec import BatchDecode, BatchPrefill, LLMExec, SingleTrace
...
class LLMEngine:
    ...
    def sort_request(self, request: LLMExec) -> None:
    ...
    def handle_prefill(self, prefills: list[BatchPrefill]) -> list[LLMResponse]:
    ...
    def handle_decode(self, decodes: list[BatchDecode]) -> list[LLMResponse]:
    ...
    def handle_trace(self, traces: list[SingleTrace]) -> list[LLMResponse]:
        return traces.pop().step()

    def add_request(self, request: LLMExec) -> None:
